...
class ProductEditPage extends Component {
  ...
  componentDidMount() {
    if (this.props.match.params.mode === 'edit') {
      axios
        .get('https://mern-product-catalog-backend-8984bcc3b1db.herokuapp.com/products/' + this.props.match.params.id)
  ...
  editProductHandler = event => {
    ...
    if (this.props.match.params.mode === 'edit') {
      request = axios.patch(
        'https://mern-product-catalog-backend-8984bcc3b1db.herokuapp.com/products/' + this.props.match.params.id,
        productData
      );
    } else {
      request = axios.post('https://mern-product-catalog-backend-8984bcc3b1db.herokuapp.com/products', productData);
    }
    request
      .then(result => {
        this.setState({ isLoading: false });
